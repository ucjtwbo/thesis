...
\textbf{Candidate:}\\
Judith Willemijn \textsc{Borghouts} % Your name
\end{flushleft}
\end{minipage}
~
\begin{minipage}{0.4\textwidth}
...
\textbf{Supervisors:} \\
Dr. Duncan P. \textsc{Brumby} \\% Supervisor's Name
...
\begin{flushright} \large
\textbf{Examiners:} \\
Dr. Catherine \textsc{Holloway}, \textit{University College London} \\% Examiner's Name
