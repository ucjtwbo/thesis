...
%Mixed media
%The studies here only looked at digital sources. Study 2 showed that participants adopted different strategies for physical and digital sources, which suggests that people are less aware of time spent on digital inquiries. Future studies could be done to compare the use of paper and digital sources in a controlled setting, and test the hypothesis that people 
