\chapter{Study 1 Materials}\label{ch:S1_Materials}
...
\chapter{Study 2 Study protocol}\label{ch:S2_Protocol}
...
{%
  ...
  \captionof{figure}[Study 7 consent form]{The consent form given to participants in Study 7.}
  \par
}
...
{%
  ...
  \captionof{figure}[Study 7 information sheet]{The information sheet given to participants in Study 7.}
  \par
}

\section{Installation instructions}\label{ch:S7_Instructions}
\begin{figure}[!htp] \centering{
